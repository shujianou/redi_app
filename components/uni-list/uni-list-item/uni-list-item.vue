	...
	<view class="uni-list-cell" :class="[disabled === true || disabled === 'true' ? 'uni-list-cell--disabled' : '']"
	 ...
	 @click="onClick">
		<view class="uni-list-cell__container">
			...
			<view class="uni-list-cell__extra" v-if="showText===true||showText==='true'||showBadge===true|| showBadge === 'true' || showArrow === true || showArrow === 'true'||showSwitch === true || showSwitch === 'true'">
				<view class="show-text" v-if="showText===true||showText==='true'">{{text}}</view>
				...
				<i v-if="showArrow === true || showArrow === 'true'" class="icon-i icon-right"></i>
